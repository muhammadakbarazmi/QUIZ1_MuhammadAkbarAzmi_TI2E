    ...
    <section class="tm-welcome-section">
      <div class="container tm-position-relative">
        ...
        <div class="row tm-welcome-content">
          ...
          <p class="gray-text tm-welcome-description">Tempat duduk tersedia sangat banyak karena lokasi warung bertingkat dan semi outdoor. <span class="gold-text">Wedangan-Cafe</span> ini merupakan tempat Hang out atau nongkrong bareng teman-teman dan juga bisa bersama <span class="gold-text">Keluarga Tercinta</span>. Banyak pilihan tempat buat Anda yang suka ngobrol kesana-kemari sambil menikmati berbagai makanan dan minuman.</p>
