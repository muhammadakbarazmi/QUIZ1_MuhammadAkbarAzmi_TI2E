        ...
        <div class="row">
          <div class="tm-top-header-inner">
            <div class="tm-logo-container">
              ...
              <h1 class="tm-site-name tm-handwriting-font">Wedangan Cafe</h1>
            </div>
    ...
    <section class="tm-welcome-section">
      <div class="container tm-position-relative">
        ...
        <div class="row tm-welcome-content">
          ...
          <h2 class="gold-text tm-welcome-header-2">Wedangan Cafe</h2>
          <p class="gray-text tm-welcome-description">Wedangan Cafe ini menawarkan fasilitas nongkrong dengan ciri khasnya yaitu Tempatnya yang nyaman dan bersih<span class="gold-text"></span> untuk <span class="gold-text">Menjaga Kebaikan Bersama</span>. Wedangan atau angkringan, seperti kita tahu, merupakan tempat nongkrong yang sederhana serta murah meriah.</p>
          ...
          <div>
              ...
              <div class="tm-position-relative margin-bottom-30">              
                <nav class="tm-side-menu">
                  <ul>
                    ...
                    <li><a href="#">Black Coffe</a></li>
                    <li><a href="#">Robusta Java Coffe</a></li>
                    <li><a href="#">Luwak Mix Coffe</a></li>
                    <li><a href="#">Arabica Java Coffe</a></li>
            ...
            <div class="tm-menu-product-content col-lg-9 col-md-9"> <!-- menu content -->
              ...
              <div class="tm-product">
                ...
                <div class="tm-product-text">
                  <h3 class="tm-product-title">Black Coffe</h3>
                  <p class="tm-product-description">Maecenas tempus, tellus eget condimentum rhoncus, sem quam semper libero, sit amet adipiscing sem neque. Red ipsum.</p>
                </div>
                <div class="tm-product-price">
              ...
              <div class="tm-product">
                ...
                <div class="tm-product-text">
                  <h3 class="tm-product-title">Robusta Java Coffe</h3>
                  <p class="tm-product-description">Maecenas tempus, tellus eget condimentum rhoncus, sem quam semper libero, sit amet adipiscing sem neque. Red ipsum.</p>
                </div>
                <div class="tm-product-price">
              ...
              <div class="tm-product">
                ...
                <div class="tm-product-text">
                  <h3 class="tm-product-title">Luwak Mix Coffe</h3>
                  <p class="tm-product-description">Maecenas tempus, tellus eget condimentum rhoncus, sem quam semper libero, sit amet adipiscing sem neque. Red ipsum.</p>
                </div>
                <div class="tm-product-price">
              ...
              <div class="tm-product">
                ...
                <div class="tm-product-text">
                  <h3 class="tm-product-title">Arabica Java Coffe</h3>
                  <p class="tm-product-description">Maecenas tempus, tellus eget condimentum rhoncus, sem quam semper libero, sit amet adipiscing sem neque. Red ipsum.</p>
                </div>
                <div class="tm-product-price">
      ...
      <div>
        <div class="container">
          <div class="row tm-copyright">
           <p class="col-lg-12 small copyright-text text-center">Copyright &copy; 2021 Wedangan Cafe</p>
         </div>  
       </div>
     </div>
